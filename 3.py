...
class IceCreamApp:
    def __init__(self, ice_cream_stand):
        ...
        self.root = Tk()
        self.root.title("Мороженое")

        self.info_frame = Frame(self.root, padx=10, pady=5)
        self.info_frame.grid(row=10, column=10, sticky=W)
        ...
        self.flavor_entry = Entry(self.info_frame, width=10)
        ...
        self.working_hours_label = Label(self.info_frame2, text="Часы работы:\n" + self.ice_cream_stand.working_hours)
...
ice_cream_stand = IceCreamStand("Папанина 13", "    пн- вс: 11:00 - 23:00")
